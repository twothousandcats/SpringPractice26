...
public sealed class OrderController
{
    ...
    private Order CollectOrder()
    {
        ...
        DateTime date = DateTime.Today.AddDays( DeliveryDaysFromNow );

        return new Order( productName, quantity, customerName, address, date );
    }
    ...
    private bool ConfirmOrder( Order order )
    {
        ...
        return _ui.Confirm( "Подтвердите (y/n): " );
    }
